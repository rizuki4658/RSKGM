		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			    <div class="modal-header">
			       	<h5 class="modal-title" id="exampleModalLabel">Filter Per Bulan</h5>
			    </div>
			<div class="modal-body">
			    <form method="post" action="../Laporan/cara_bayar/bulan.php">
			    	...
			    	<div class="form-group" id="input_bulan">
					    ...
					    <select class="form-control" name="bulan" id="bulan" aria-describedby="emailHelp" required>
					    	<option></option>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#btn_reset').click(function(){
				$('#input_tahun').fadeOut(700);
				$('#btn_reset').fadeOut(600);
				$('#btn_ok').fadeOut(500);
			});
