						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
									...
									<li><a href="Ortodonti.php">- Klinik Ortodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Ortodonti">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Ortodonti">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Ortodonti">Per Tahun</a></li>
