						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="Prostodonti.php">- Klinik Prostodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Prostodonti">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Prostodonti">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Prostodonti">Per Tahun</a></li>
