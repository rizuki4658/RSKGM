						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="7 Eksodonti/Eksodonti.php">- Klinik Eksodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="filter/filter_bulan.php?page=index">Per Bulan</a></li>
									<li><a href="filter/filter_triwulan.php?page=index">Per Triwulan</a></li>
									<li><a href="filter/filter_Tahun.php?page=index">Per Tahun</a></li>
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu" id="pilih_bayar">
											<li><a href="filter/cara_bulan.php?page=index">Per Bulan</a></li>
											<li><a href="filter/cara_triwulan.php?page=index">Per Triwulan</a></li>
											<li><a href="filter/cara_Tahun.php?page=index">Per Tahun</a></li>
										</ul>
									</li>
								</ul>
							</li>
							...
							<li class="dropdown" <?php echo $data_user; ?> >
								...
								<ul class="dropdown-menu" style="text-align: right;">
			        				...
			        				<li><a href="Login Daftar/Login/proses_logout.php" onclick="return confirm('Anda ingin logut?')">LOGOUT</a></li>
								</ul>
							</li>
						</ul>
					</div>
