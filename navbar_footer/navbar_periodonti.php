						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="Periodonti.php">- Klinik Periodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Periodonti">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Periodonti">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Periodonti">Per Tahun</a></li>
