						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="Oral Surgery.php">- Klinik Oral Surgery</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Oral Surgery">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Oral Surgery">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Oral Surgery">Per Tahun</a></li>
