						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="UGD.php">- Klinik UGD</a></li>
								</ul>
							</li>
							<li class="dropdown" <?php echo $laporan; ?> >
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">LAPORAN <i class="caret"></i></a>
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=UGD">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=UGD">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=UGD">Per Tahun</a></li>
