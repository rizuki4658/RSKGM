						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="Konservasi Gigi.php">- Klinik Konservasi Gigi</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Konservasi Gigi">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Konservasi Gigi">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Konservasi Gigi">Per Tahun</a></li>
