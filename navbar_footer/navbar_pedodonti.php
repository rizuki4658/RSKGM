						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="Pedodonti.php">- Klinik Pedodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Pedodonti">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Pedodonti">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Pedodonti">Per Tahun</a></li>
