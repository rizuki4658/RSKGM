						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown" <?php echo $layanan; ?> >
								...
								<ul class="dropdown-menu">
			        				...
			        				<li><a href="Endodonti.php">- Klinik Endodonti</a></li>
							...
							<li class="dropdown" <?php echo $laporan; ?> >
								...
								<ul class="dropdown-menu">
									<li><a href="../filter/filter_bulan.php?page=Endodonti">Per Bulan</a></li>
									<li><a href="../filter/filter_triwulan.php?page=Endodonti">Per Triwulan</a></li>
									<li><a href="../filter/filter_Tahun.php?page=Endodonti">Per Tahun</a></li>
