<?php
	    ...
	    $total16=0;
	    $tgl=date("d M Y");
	    $query1="SELECT * FROM prostodonti ORDER BY tgl ASC LIMIT 100";
	    $query2="SELECT * FROM prostodonti WHERE status='Umum' ORDER BY tgl ASC LIMIT 100";
	    $query3="SELECT * FROM prostodonti WHERE status='BPJS' ORDER BY tgl ASC LIMIT 100";
	    $query4="SELECT * FROM prostodonti WHERE status='Gratis' ORDER BY tgl ASC LIMIT 100";
	    ...
	    if (mysqli_num_rows($excute1)>0) {
	    	while ($data1=mysqli_fetch_assoc($excute1)) {
	    		$total1+=$data1['ip1']+$data1['ip2']+$data1['ip3']+$data1['ip4']+$data1['ip5']+$data1['ip6']+$data1['ip7']+$data1['ip8']+$data1['ip9'];
			    $total2+=$data1['ip10']+$data1['ip11']+$data1['ip12']+$data1['ip13'];
			    $total3+=$data1['ip14']+$data1['ip15'];
	            $total4+=$data1['ip16']+$data1['ip17'];
	            $total5+=$data1['ip18']+$data1['ip19']+$data1['ip20']+$data1['ip21']+$data1['ip22'];
	            $total6+=$data1['ip23']+$data1['ip24']+$data1['ip25'];
	            $total7+=$data1['ip26'];
	            $total8+=$data1['ip27'];
	            $total9+=$data1['ip28'];
	            $total10+=$data1['ip29'];
