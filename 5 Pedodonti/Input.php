...
<?php require '../navbar_footer/navbar_pedodonti.php'; ?>
	...
	<div class="container-fluid bg">
		...
		<h4 style="color: white; text-transform: uppercase; margin-bottom: 0; display: inline;">
			<a href="Pedodonti.php" class="links">KLINIK PEDODONTI</a>
		</h4>
	...
	<div class="container">
	    <h4 class="mb-3">Tambah Data Pedodonti </h4>
	    <br>
	    <div class="box">
